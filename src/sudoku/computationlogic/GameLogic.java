...
public class GameLogic {
     ...
     *
     *  grid A virtual representation of a sudoku puzzle, which may or may not be solved.
     *  Either GameState.Active or GameState.Complete, based on analysis of solvedSudoku.
     *
     * Rules:
     ...
     *
     *  grid A copy of the Sudoku Game's grid state to compare against
     *
     */
